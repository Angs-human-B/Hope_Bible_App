...
String onboarding16String2 =
    "A few verses a day can shift your mindset, build\nclarity, and guide your path forward.";
String onboarding17String =
    "90% report deeper\nspiritual understanding\n—join their ranks.";
String onboarding18String = "Scripture in Your\nRoutine";
String onboarding19String = "Real people. Real change.";
String onboarding18String2 =
    "Small moments matter—read during coffee, your\ncommute, or quick breaks to stay spiritually\ngrounded.";
String onboarding19String2 =
    "Daily scripture helped them grow—and your story\ncould be next.";
String onboarding20String = "Wisdom That\nEndures";
String onboarding20String2 =
    "The faith and choices of biblical figures still\necho today—offering clarity, courage, and\ntruth for modern life.";
String onboarding21String = "Rooted in Wisdom";
String onboarding21String2 =
